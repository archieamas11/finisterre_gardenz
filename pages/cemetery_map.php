<?php
function renderCemeteryMapOverview($mysqli) {
        ...
        <div class="card-body p-0">
            <div class="map-management-container">
                ...
                <div class="searchbar-container d-flex gap-3 justify-content-center align-items-center">
                    ...
                    <div class="button-wrapper">
                        <a href="#" class="advanced-search-icon" data-bs-toggle="modal"
                            data-bs-target="#importMapJson" title="Advanced Search" aria-label="Import Map JSON"
                            data-bs-placement="bottom">
...
<div class="modal fade" id="importMapJson" tabindex="-1" aria-labelledby="mapFilterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-box-arrow-in-down me-2"></i>Import Map JSON file</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4">
                <p class="text-muted mb-3">
                    Import a JSON file containing cemetery plot data to update the map. Ensure the file is in the correct
                    format.
                </p>
                <input type="file" class="form-control mb-3" id="jsonFileInput"
                    accept=".json" onchange="handleFileSelect(event)">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="importJsonButton">Import JSON</button>
            </div>
        </div>
    </div>
</div>
