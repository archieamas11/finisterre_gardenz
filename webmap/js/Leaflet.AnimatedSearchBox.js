(function (factory, window) {
    ...
    L.Control.Searchbox = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            // Auto-collapse when losing focus
            L.DomEvent.on(this._input, 'blur', this._onBlur, this);
        ...
        onRemove: function (map) {
            ...
            L.DomEvent.off(this._input, 'blur', this._onBlur, this);
        ...
        _onBlur: function () {
            // Delay the collapse to allow clicking on autocomplete items
            setTimeout(() => {
        ...
        _onDocumentClick: function (e) {
            ...
            if (!this._container.contains(e.target) && !this._collapsed) {
                this.hide();
            }
        },
        ...
        _create: function () {
            this._container = L.DomUtil.create('div', 'leaflet-searchbox-container');
